...
const apiKey = 'f5a4ed1f797a72dc41c1c40b0bcef3a7'; // Your OpenWeatherMap API key here
...
function App() {
  ...
  */
  ...
  const updateCityData = (cityData) => {
    setSelectedCity(cityData) // might need to access elements from cityData
  }
  ...
  return (
    <div className="app-container">
      ...
      */}
      ...
      <SideContainer apiKey={apiKey} setSelectedCity={updateCityData}  /* Pass the city data update function as a prop to 'SideContainer' */ />
    </div>
  );
}
